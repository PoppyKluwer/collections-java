...
public class LivrariaOnline {
    ...
    public Map<String, Livro> exibirLivrosOrdenadosPorPreco(){
        List<Map.Entry<String, Livro>> livrosPorPreco = new ArrayList<>(livrariaOnlineMap.entrySet());
    ...
    public Map<String, Livro> exibirLivrosOrdenadosPorAutor() {
        List<Map.Entry<String,Livro>> livrosParaOrdenadorPorAutor = new ArrayList<>(livrariaOnlineMap.entrySet());
        Collections.sort(livrosParaOrdenadorPorAutor, new ComparatorPorAutor());

        Map<String, Livro> livrosOrdenadosPorAutor = new LinkedHashMap<>();

        for (Map.Entry<String, Livro> entry : livrosParaOrdenadorPorAutor) {
